/*https://github.com/skidding/dragdealer*/
    ...
    (this,function(){
        ...
        if(!this.handle){return}this.init();
            ...
            getWrapperElement:function(wrapper){
                ...
                getHandleElement:function(wrapper,handleClass){
                    var childElements=wrapper.getElementsByTagName("div"),
                        handleClassMatcher=new RegExp("(^|\\s)"+handleClass+"(\\s|$)"),i;
                                            ...
                                            bindEventListeners:function(){
                                                ...
                                                unbindEventListeners:function(){
                                                    ...
                                                    onHandleMouseDown:function(e){
                                                        ...
                                                        this.activity=false;this.startDrag()
                                                    },
                                                        onHandleTouchStart:function(e){
                                                            Cursor.refresh(e);
                                                            stopEventPropagation(e);
                                                            this.activity=false;
                                                            this.startDrag()},onDocumentMouseMove:function(e){
                                                                Cursor.refresh(e);
                                                                if(this.dragging){this.activity=true}
                                                            },
                                                                                                ...
                                                                                                disable:function(){
                                                                                                    ...
                                                                                                    reflow:function(){
                                                                                                        ...
                                                                                                        getStep:function(){
                                                                                                            ...
                                                                                                            getValue:function(){
                                                                                                                return this.value.target},setStep:function(x,y,snap){
                                                                                                                    ...
                                                                                                                    setValue:function(x,y,snap){
                                                                                                                        ...
                                                                                                                        if(snap){
                                                                                                                            this.groupCopy(this.value.current,this.value.target);this.updateOffsetFromValue();
                                                                                                                        ...
                                                                                                                        startTap:function(){
                                                                                                                            ...
                                                                                                                            this.tapping=true;this.setWrapperOffset();
                                                                                                                                ...
                                                                                                                                startDrag:function(){
                                                                                                                                    ...
                                                                                                                                    stopDrag:function(){
                                                                                                                                        ...
                                                                                                                                        if(this.options.slide){
                                                                                                                                            ...
                                                                                                                                            target[0]+=ratioChange[0]*4;target[1]+=ratioChange[1]*4
                                                                                                                                        }
                                                                                                                                        ...
                                                                                                                                        callAnimationCallback:function(){
                                                                                                                                            ...
                                                                                                                                            callTargetCallback:function(){
                                                                                                                                                ...
                                                                                                                                                animate:function(direct,first){
                                                                                                                                                    ...
                                                                                                                                                    this.offset.current=this.getOffsetsByRatios(this.value.current)}else{this.offset.current=this.getOffsetsByRatios(this.getClosestSteps(this.value.current))
                                                                                                                                                    }
                                                                                                                                                    ...
                                                                                                                                                    return[proper[0]+(value[0]-proper[0])/4,proper[1]+(value[1]-proper[1])/4]},getProperValue:function(value){
                                                                                                                                                    ...
                                                                                                                                                    return[this.getRatioByOffset(group[0],this.bounds.availWidth,this.bounds.left),this.getRatioByOffset(group[1],this.bounds.availHeight,this.bounds.top)]},getRatioByOffset:function(offset,range,padding){
                                                                                                                                                    return range?(offset-padding)/range:0},getOffsetsByRatios:function(group){
                                                                                                                                                    return[this.getOffsetByRatio(group[0],this.bounds.availWidth,this.bounds.left),this.getOffsetByRatio(group[1],this.bounds.availHeight,this.bounds.top)]},getOffsetByRatio:function(ratio,range,padding){
                                                                                                                                                    return Math.round(ratio*range)+padding},getStepNumber:function(value){
                                                                                                                                                    ...
                                                                                                                                                    var k=0;var min=1;for(var i=0;i<=this.options.steps-1;i++){
...
var Position={
    get:function(obj){
        var curleft=0,curtop=0;if(obj.offsetParent){
            do{
...
$(document).ready(function(){
	...
	//set defaults
	$("#plan-holder").text('Properties:');
	var price = getPrice(10, 40);
        $(".total-price").html('$'+price.total+' / month');
		$(".info-price").html('$'+price.afterDiscount+' / month'); 
	    $(".annual-price").html('Save '+price.discountAmount+'%'); 
	    $("#device-holder").text(slider_value);
        

    new Dragdealer('pr-slider', {
    animationCallback: function(x, y) {
        $("#txd_Propcount").val((Math.round(x * 1000)));
      var slider_value = ((Math.round(x * 1000)));
      $("#pr-slider .value").text(slider_value);
      var stripe_width = slider_value/10+1;
      $(".stripe").css("width", ""+stripe_width+"%");
	
        var baseRate = $("input[name='currency']:checked").val()
        
        updatePrice(baseRate, slider_value);
    }
})
    
var currSymbol = "$";
var getCurrSymbol = (numRate) => {
    if (numRate > 7) {
        return currSymbol = "$";
    } else {
        return currSymbol = "€";
...
function updatePrice(baseRate, numProperties) {
    		var price = getPrice(baseRate, numProperties);
        getCurrSymbol(baseRate);
        $(".total-price").html(currSymbol+price.total+' / month');
		$(".info-price").html(currSymbol+price.afterDiscount+' / month'); 
	    $(".annual-price").html('Save '+price.discountAmount+'%'); 
	    $("#device-holder").text(slider_value);
}